...
//public class RedFarGate20 extends LinearOpMode {
//
...
//        Pose2d stackIntakingPos = new Pose2d(52,-3,Math.toRadians(-90));
//
//        Pose2d spike3Avoid = new Pose2d(29, 8,Math.toRadians(-90));
//        Pose2d spike2Avoid = new Pose2d(52,0 , Math.toRadians(180));
//        Pose2d spike1Avoid = new Pose2d(48, 2, Math.toRadians(180));
//        Pose2d MiddleTile = new Pose2d(52,-74, Math.toRadians(-90));
//        Pose2d spike1 = new Pose2d(37.5, 10.5, Math.toRadians(180));
//        Pose2d spike2 = new Pose2d(37, 12, Math.toRadians(-90));
//        Pose2d spike3 = new Pose2d(28.5, 5, Math.toRadians(-90));
...
//        Pose2d boardRight = new Pose2d(11.75, -75, Math.toRadians(-90));
...
////
//////@Disabled
////@Autonomous(name = "Red Far Gate 2+1")
